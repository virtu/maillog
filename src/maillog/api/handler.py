...
class RequestHandler:
    ...
    @staticmethod
    def handle_request(client_socket: APISocket, event_buffer: EventBuffer):
        ...
        try:
            ...
            if isinstance(msg, messages.APISubmitEventRequest):
                ...
                RequestHandler.handle_submit(msg, client_socket, event_buffer)
            elif isinstance(msg, messages.APIGetStatusRequest):
                log.debug("Received status request.")
                RequestHandler.handle_status(client_socket, event_buffer)
            else:
    ...
    @staticmethod
    def handle_status(client_socket: APISocket, event_buffer: EventBuffer):
        """
